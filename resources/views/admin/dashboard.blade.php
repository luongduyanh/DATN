	...
	<div class="row">
		...
		<div class="col-md-4 col-xs-12">
			...
			<ol class="list_views">
				...
				<li>
					<a style="color:black" target="_blank" href="{{url('/bai-viet/'.$post->post_slug)}}">{{$post->post_title}} | <span style="color:white">{{$post->post_views}}</span></a>
				</li>
				@endforeach
			</ol>
		...
		<div class="col-md-4 col-xs-12">
			...
			<ol class="list_views">
				...
				<li>
					<a style="color:black" target="_blank" href="{{url('/chi-tiet/'.$pro->product_slug)}}">{{$pro->product_name}} | <span style="color:white">{{$pro->product_views}}</span></a>
				</li>
				@endforeach
			</ol>
