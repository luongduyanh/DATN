    ...
    public function boot()
    {
        view()->composer('*', function ($view) {
            ...
            $view->with('min_price', $min_price)->with('max_price', $max_price)
                ...
                ->with('app_product', $app_product)->with('app_post', $app_post)
                ->with('app_order', $app_order)->with('app_video', $app_video)
                ->with('app_customer', $app_customer)->with('share_image', $share_image)
                ->with('icons', $icons)->with('icons_doitac', $icons_doitac)
