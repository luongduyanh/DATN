...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 05, 2021 lúc 07:21 PM
...
(21, 'Card đồ họa', 'Card đồ họa', 'card-do-hoa', 'Card đồ họa', 20, 0, NULL, NULL, NULL);
...
--
ALTER TABLE `tbl_shipping`
  MODIFY `shipping_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
